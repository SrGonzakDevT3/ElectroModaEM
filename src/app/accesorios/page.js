...
export default async function Accesorios() {
  ...
  const productos = await getProducts("accesorios");
  return (
    <main className="min-h-screen bg-white text-gray-900">
      <Navbar />
      <section className="relative bg-black text-white">
        <div className="absolute inset-0"><Image src="/colecciones/accesorios.jpg" alt="Accesorios" fill sizes="100vw" style={{ objectFit: "center", opacity: 0.45 }} /></div>
        <div className="relative z-10 max-w-6xl mx-auto px-6 py-32"><h1 className="text-5xl font-extrabold">Accesorios</h1><p className="mt-4 text-gray-200 max-w-xl">Complementa tu estilo con energía y actitud.</p></div>
      </section>
